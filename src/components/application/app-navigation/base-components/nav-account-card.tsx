...
import { ChevronSelectorVertical, LogOut01, Plus, Settings01, User01 } from "@untitledui/icons";
        ...
        >
            <div className="rounded-xl bg-primary ring-1 ring-secondary">
                <div className="flex flex-col gap-0.5 py-1.5">
                    <NavAccountCardMenuItem label="Voir le profil" icon={User01} shortcut="⌘K->P" />
                    <NavAccountCardMenuItem label="Paramètres" icon={Settings01} />
                </div>
                <div className="flex flex-col gap-0.5 border-t border-secondary py-1.5">
                    <div className="px-3 pt-1.5 pb-1 text-xs font-semibold text-tertiary">Changer de compte</div>
