...
export const DropdownMenuFeatureCard = () => {
    return (
        <div className="px-3 pb-2 md:max-w-160 md:p-0">
            <nav
                className="flex flex-col overflow-hidden rounded-xl md:w-max md:flex-row md:rounded-2xl"
                style={{
            ...
            >
                ...
                <div className="px-1 pt-2 pb-3 md:max-w-76 md:px-2" style={{ backgroundColor: "var(--glass-bg-subtle)" }}>
                    <FeatureCardVertical
                        href="#"
