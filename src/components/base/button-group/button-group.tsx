...
export const styles = sortCx({
    common: {
        root: [
            "group/button-group inline-flex h-max cursor-pointer items-center bg-white font-semibold whitespace-nowrap text-secondary ring-1 ring-[#E5E2DC] outline-brand transition duration-100 ease-linear ring-inset",
