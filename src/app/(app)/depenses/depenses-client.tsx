...
export default function DepensesClient({ initialData, initialPeriode }: DepensesClientProps) {
    ...
    const handlePeriodeChange = (newPeriode: string) => {
        ...
        startTransition(() => {
            router.push(`/depenses?periode=${newPeriode}`);
        });
    };
